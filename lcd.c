...
const u8 lcd_seg_char1[] = {
    95,159,223,222,158,94,30,
    79,143,207,221,157,93,29,
    78,142,206,220,156,92,28,
    77,141,205,219,155,91,27,
    76,140,204,218,154,90,26,
    0
};
const u8 lcd_seg_char2[] = {
    75,139,203,217,153,89,25,
    74,138,202,216,152,88,24,
    73,137,201,215,151,87,23,
    72,136,200,214,150,86,22,
    71,135,199,213,149,85,21,
    0
};
const u8 lcd_seg_char3[] = {
    84,148,212,211,147,83,19,
    70,134,198,210,146,82,18,
    69,133,197,192,128,64,32, // 32 is using unused bit 6 to not have 0x00
    68,132,196,193,129,65,1,
    67,131,195,194,130,66,2,
    0
};
